"""
Alembic environment configuration for Legal-Ops backend.
"""
...
def run_migrations_offline() -> None:
    ...
    """
    # Use database URL directly from settings (avoids interpolation issues)
...
def run_migrations_online() -> None:
    ...
    """
    # Create engine directly from settings (avoids ini file interpolation issues)
