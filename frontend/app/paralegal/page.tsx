                    ...
                    <div className="relative z-10">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            <div className="flex-1 space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-[var(--bg-tertiary)]/50 border border-[var(--border-light)]">
                                            <feature.icon className="w-5 h-5 text-[var(--teal-primary)] mt-0.5" />
                                            <div>
                                ...
                                <div className="pt-4">
                                    ...
                                    <p className="mt-3 text-xs text-[var(--text-tertiary)] flex items-center gap-2">
                                        <span className="w-1.5 h-1.5 rounded-full bg-[var(--emerald)]"></span>
                            ...
                            <div className="w-full md:w-1/3 aspect-video md:aspect-square rounded-xl bg-[#0d1117] border border-[var(--border-light)] flex items-center justify-center relative overflow-hidden shadow-2xl">
                                ...
                                <div className="w-3/4 h-3/4 bg-[var(--bg-card)] rounded-lg border border-[var(--border-light)] p-4 space-y-3 relative z-10 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                                    ...
                                    <div className="absolute bottom-4 right-4 w-8 h-8 rounded-full bg-[var(--teal-primary)] flex items-center justify-center">
