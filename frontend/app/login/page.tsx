        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#D4A853] selection:text-black flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md p-8 md:p-12">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-gray-300 text-sm text-center uppercase tracking-widest">Legal Intelligence Portal</p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link
                                    ...
                                    className="text-[10px] items-center text-gray-400 hover:text-white transition-colors uppercase tracking-wider"
                                >
                                    Forgot password?
                                </Link>
                            </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#D4A853] hover:bg-[#E8C775] text-white font-bold py-4 rounded-lg flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(212,168,83,0.1)] hover:shadow-[0_0_30px_rgba(212,168,83,0.3)] disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-widest text-xs"
                        >
                            {loading ? (
                ...
                <p className="mt-8 text-center text-xs text-gray-400 tracking-wide">
                    ...
                    <Link href="/signup" className="font-bold text-[#D4A853] hover:text-white transition-colors underline decoration-[#D4A853]/50 underline-offset-4">
                        Request Access
                    </Link>
                </p>
